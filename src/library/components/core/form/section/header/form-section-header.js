...
const formSectionHeader = ({ cssClasses, style, children }) => {
    return (
        <div className={classNames('form-section-header', cssClasses)} style={style}>
            {children}
        </div>
    );
};
...
export { formSectionHeader as FormSectionHeader, formSectionHeaderTitle as FormSectionHeaderTitle };
